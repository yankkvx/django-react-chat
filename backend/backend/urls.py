...
from users.views import UserViewSet, ObtainJWTWithCookiesView, RefreshJWTWithCookiesView, Logout, RegisterUser, UserManagement
...
urlpatterns = [
    ...
    path('api/users/profile/', UserManagement.as_view(), name='user-management')
] + router.urls
